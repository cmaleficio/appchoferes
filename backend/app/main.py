...
from .routers import expenses, telemetry, auth, users, budgets, routes, logs, exchange_rates, deposits, uploads, reports
...
app.include_router(uploads.router, prefix="/api/expenses", tags=["expenses"])
